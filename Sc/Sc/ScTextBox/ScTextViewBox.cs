...
namespace Sc
{
    public class ScTextViewBox : ScLayer
    {
        ...
        public ScTextViewBox(ScMgr scMgr = null)
        {
            ...
            SizeChanged += ScTextBox2_SizeChanged;
        ...
        private void ScTextBox2_SizeChanged(object sender, SizeF oldSize)
        {
            textView.ForeFont = ForeFont;
