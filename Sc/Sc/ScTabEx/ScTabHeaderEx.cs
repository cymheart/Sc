...
namespace Sc
{
    public class ScTabHeaderEx : ScLayer
    {
        ...
        public ScTabHeaderEx(ScMgr scmgr = null)
            : base(scmgr)
        {
           IsUseDebugPanitCode = true;
            ...
            SizeChanged += ScTabHeaderEx_SizeChanged;
        }

        private void ScTabHeaderEx_SizeChanged(object sender, SizeF oldSize)
        {
            preNextBtn.Width = 50;
