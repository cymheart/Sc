...
namespace Sc
{
    public class ScTextViewEx : ScLayer
    {
        ...
        public ScTextViewEx(ScMgr scmgr = null)
            :base(scmgr)
        {
            ...
            MouseDown += ScTextViewEx_MouseDown;
            MouseMove += TxtView_MouseMove;
            MouseUp += ScTextViewEx_MouseUp;
            KeyDown += TxtView_KeyDown;
            KeyUp += ScTextViewEx_KeyUp;
        ...
        private void ScTextViewEx_ReBulid(object sender)
        {
        ...
        private void ScTextViewEx_MouseDown(object sender, ScMouseEventArgs e)
        {
            metricsList = null;
            Focus();
        ...
        private void ScTextViewEx_MouseUp(object sender, ScMouseEventArgs e)
        {
            if (metricsList == null)
                selectedTxt = "";
        }

        private void ScTextViewEx_KeyUp(object sender, KeyEventArgs e)
        {
            if (IsOnlyRead)
                return;
