...
namespace Sc
{
    public class ScLayer : ScObject,IDisposable
    {
        ...
        private void _CreateHitGeometry()
        {
            ...
            switch (scMgr.GraphicsType)
            {
                case GraphicsType.GDIPLUS:
                    if (GDIHitGeometry != null)
                        hitGraphicsPath = GDIHitGeometry((GDIGraphics)ScMgr.Graphics);
                    else
                        hitGraphicsPath = CreateHitGeometryByGDIPLUS((GDIGraphics)ScMgr.Graphics);
                    break;
        ...
        public virtual void OnGDIPaint(ScGraphics g)
        {
            GDIPaint?.Invoke((GDIGraphics)g);
        }
        ...
        public delegate void ScGDIPaintEventHandler(GDIGraphics g);
        ...
        public delegate GraphicsPath CreateHitGeometryGDIEventHandler(GDIGraphics gdiGraphics);
        public event CreateHitGeometryGDIEventHandler GDIHitGeometry = null;
        ...
        public event ScGDIPaintEventHandler GDIPaint;
