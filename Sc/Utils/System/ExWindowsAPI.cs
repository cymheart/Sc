...
namespace API
{
    ...
    public class CommonConst
    {
        ...
        public const int STANDARD_RIGHTS_READ = CommonConst.READ_CONTROL;
        public const int STANDARD_RIGHTS_WRITE = CommonConst.READ_CONTROL;
        public const int STANDARD_RIGHTS_EXECUTE = CommonConst.READ_CONTROL;
        ...
        public const int KEY_READ = ((CommonConst.STANDARD_RIGHTS_READ | CommonConst.KEY_QUERY_VALUE | CommonConst.KEY_ENUMERATE_SUB_KEYS | CommonConst.KEY_NOTIFY) & (~CommonConst.SYNCHRONIZE)) ;
        public const int KEY_WRITE = ((CommonConst.STANDARD_RIGHTS_WRITE | CommonConst.KEY_SET_VALUE | CommonConst.KEY_CREATE_SUB_KEY) & (~CommonConst.SYNCHRONIZE));
        public const int KEY_EXECUTE = ((CommonConst.KEY_READ) & (~CommonConst.SYNCHRONIZE));
